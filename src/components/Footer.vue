        ...
        <div @click="top()" class="max-w-[1200px] mx-auto relative">
            ...
            <div class="flex gap-[20px] border-b-[1px] border-[#ddd2c263] pb-[80px]">
                <div class="flex flex-1 items-center roboto-regular text-[#DDD2C2]">
                    ...
                    <div>
                        <a class="hover:text-[#0652dd] text-[14px] duration-[.3s]" href="tel:+998915491754">+998(91)
                            549-17-54</a>
                        <p class="hover:text-[#0652dd] text-[14px] my-[15px] duration-[.3s]">info@electrogenco.com</p>
                ...
                <div class="flex flex-1 items-center roboto-regular text-[#DDD2C2]">
                    ...
                    <div>
                        <a class="hover:text-[#0652dd] text-[14px] duration-[.3s]" href="tel:+998915491754">+998(91)
                            549-17-54</a>
                        <p class="hover:text-[#0652dd] text-[14px] my-[15px] duration-[.3s]">info@electrogenco.com</p>
                        <p class="hover:text-[#0652dd] duration-[.3s] text-[14px]">No. 22, Golestan Som, Ahmadabad
                            {{ $t("footer.address2") }}</p>
                    </div>
                </div>
            </div>
