...
<template>
    <header class="py-[15px] z-[999] shadow-sm bg-white fixed w-[100%]">
        ...
        <div class="flex items-center justify-between max-w-[1250px] mx-auto">
            <img @click="$router.push('/')" class="h-[50px] cursor-pointer"
            ...
            <div class="flex items-center gap-[20px]">
                <div @click="searchs()" class="cursor-pointer">
                ...
                <div class="dropdown">
                    <div tabindex="0" role="button "
                        ...
                        {{ $i18n.locale }}</div>
                    <ul tabindex="0"
                        class="dropdown-content z-[99] w-[max-content] menu p-2 shadow bg-base-100 rounded-box">
                        <li @click="changeLanguage('uz'), $i18n.locale = 'uz'" v-if="!this.uzbek"><a
                                class="font-[700] text-[14px]">UZ <img class="h-[20px] w-[30px]"
                        ...
                        <li @click="changeLanguage('ru'), $i18n.locale = 'ru'" v-if="!this.russian"><a
                                class="font-[700] text-[14px]">RU <img class="h-[20px] w-[30px]"
                        ...
                        <li @click="changeLanguage('en'), $i18n.locale = 'en'" v-if="!this.english"><a
                                class="font-[700] text-[14px]">EN <img class="h-[20px] w-[30px]"
                ...
                <router-link :to="'/'"
                    class="flex gap-[20px] duration-[.3s] uppercase roboto-regular text-[#1B3F7B] hover:text-[#5380BE] font-[600] text-[17px]">
                    {{ $t("header.customer") }}
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
...
.searchBack:hover :nth-child(3), .searchBack:hover :nth-child(1){
