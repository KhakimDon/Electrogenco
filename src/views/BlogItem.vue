...
<template>
    <div id="begin" class="pt-[75px] max-w-[1250px] mx-auto">
        ...
        <div class="max-w-[900px] mx-auto sm:px-[20px] sm:w-[100%]">
            ...
            <div class="mt-[40px] sm:mt-[15px] flex sm:text-[15px] sm:gap-[5px] gap-[10px] items-center roboto-medium text-[#8295C6]">
                
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6 sm:h-[20px] sm:w-[20px]">
